...
from app.modules.customers.interfaces.api.schemas.customer import CustomerCreate, CustomerUpdate, CustomerUpsert, CustomerResponse, CustomerPipelineUpdate
from app.modules.customers.interfaces.api.dependencies.customers import (
