...
from app.modules.tickets.interfaces.api.schemas.ticket import TicketCreate, TicketUpdate, TicketResponse
from app.modules.tickets.interfaces.api.dependencies.tickets import (
    get_create_ticket_use_case,
    get_list_customer_tickets_use_case,
    get_update_ticket_use_case
)
from app.modules.tickets.interfaces.api.dependencies.tickets import get_customer_projection_repository
...
async def create_ticket(
    ...
    customer_repo = Depends(get_customer_projection_repository),
