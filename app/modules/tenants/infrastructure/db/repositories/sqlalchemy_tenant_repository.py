...
from app.modules.tenants.domain.entities.tenant import Tenant as DomainTenant
from app.modules.tenants.domain.ports.tenant_repository import TenantRepository
from app.modules.tenants.infrastructure.db.models.tenant import Tenant as DbTenant
